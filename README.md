...
<p> One of the weakness of this map is that it does not include many thematic layers and additional interactive features. This limits the user experience and declines user satisfaction in the map design and interface. The only <strong>thematic layers </strong> used in these maps are markers with images as their icons and image pop-ups for these markers. Even though this gives an interactive experience it limits the world of possibility as more interactive elements can be added to these maps in order to further engage the user and make the map more creative. The maps also are not draggable as they only visualize the required area making it unable for the user to move around and explore the non-visible sections of the map. This restricts the user and his abilities to further understand the surrounding areas of the national parks. The limited interactive features and thematic layers reduces the appeal of this story map to its users and does not allow them to go further with than visual content consumption.</p>

This map uses map elements like scalar bar, legend, attribution and credit, additional information, and github link. These map elements help in better understand and interpretation of the web map. Let's have a look at some of these elements.
- **Legend** - There is a legend available in the top right corner of the Sundarbans National Park map. This legend denotes green to be the color of the forests.
- **Attribution** - The attribution and credit for the creation of this map has been given to Storymap.js in the bottom right corner of the screen as this library has made this whole project easy to execute and possible in a given time frame.
- **About** - The information buttion is the third button in the top right corner of the screen and gives additional information on the making of this map and provides a link to a youtube video that describes the implications of this project.
- **Github link** - The github icon in the top right corner takes you directly to the repository where the content and code of this map is hosted and provides an easy shortcut to developers to access this open source information.

### Social Implications and Awareness
<p>This map takes up the the task of creating awareness about the wildlife and vegetation present in the national parks of India. This project will not only provide information and increase knowledge but also increase the number of visitors and tourists to these parks giving a boost to the tourism and forest industry. Tourists and wildlife enthusiasts can view this information and decide the national parks they want to visit. As this map will be hosted as a open resource on the web, people from all around the world can view which can increase the international approach and foreign tourism in India.</p>
<p>The project will definitely raise awareness on the depleting endangered species in Indian national parks and call for increase in funds for wildlife and forest conservation. Protection of forest spaces in order to conserve the environment of wild animals especially endangered species is extremely important as mankind is increasingly taking away natural lands and habitats pusing these animals out of their inherent homes. This project will serve its purpose as it will work as an advertisement for national parks in India drawing people's attention towards the beauty and serenity nature and wildlife has to offer. It also provides textual facts of the amount of species left in these national parks drawing attention towards saving these species and preventing illegal activities like poaching. This will also generate sympathy amongst the audiences for the conditions of these animals and call upon steps for increasing their population. It illustrates what nature has to offer.</p>
<p>This project breaks through the economic divide as people having internet access can use this map to gain knowledge about national parks in India without actually having the resources to visit India, reaching a wide range of people. It still does not manage to break through the digital divide as it can only be accessed by people having internet access. The power relationship we get to see in this project is more ecological than social in its ways. It is the equation of mankind with forests and wildlife. Definitely mankind possesses more power in this equation as it has the capacity to destroy nature. But sure when nature strikes back mankind is not equipped to handle its wrath. </p>
